...
### install backup images
#${APP} --addr=${ADDR} --fpga=/home/basti/src/uhd/backup_images/usrp_n210_r4_fpga.bin
#${APP} --addr=${ADDR} --fw=/home/basti/src/uhd/backup_images/usrp_n210_fw.bin
#exit
